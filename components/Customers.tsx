const Customers = () => {
  return (
    <article className="border-b py-2 bg-gradient-to-r from-orange-200 via-orange-500 to-orange-800">
      <div className="container mx-auto flex flex-wrap items-center justify-between pb-10">
        {/* title */}
        ...
        <div className="w-full mb-4">
          <div className="h-1 mx-auto w-64 opacity-25 my-0 py-0 rounded-t bg-orange-200"></div>
        </div>

        {/* list of customers */}
        <section className="flex flex-1 flex-wrap max-w-4xl mx-auto items-center justify-center lg:justify-between text-xl text-white font-bold opacity-75">
          <span className="w-1/2 p-4 md:w-auto flex items-center">
            <svg
              className="h-10 w-10 mr-4 fill-current text-white opacity-75"
