...
const Contact = () => {
  ...
  return (
    <>
      ...
      {/* contact */}
      <article className="relative min-w-screen min-h-screen flex justify-center items-center mt-5 bg-gradient-to-r from-orange-800 via-orange-500 to-orange-200">
        <div className="container h-full max-w-5xl mx-auto overflow-hidden rounded-lg shadow">
          <div className="h-full sm:flex">
            {/* contact links */}
            <aside className="w-full p-10 rounded-none bg-orange-100 md:w-1/3 sm:rounded">
              ...
              <div className="flex items-start py-3 pt-5">
                <div className="flex-shrink">
                  <svg
                    className="w-8 h-8 mt-1 text-orange-800"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
            ...
            <section className="flex items-center justify-center w-full p-10 bg-white md:w-2/3">
              <form className="w-full" onSubmit={onSubmit}>
                ...
                <div className="pt-3">
                  <button
                    className="flex px-6 py-3 text-white bg-orange-500 rounded-md hover:bg-orange-600 hover:text-white focus:outline-none focus:shadow-outline focus:border-indigo-300"
                    type="submit"
                  >
                    <svg
