...
//     title: 'Quality',
//     subtitle:
//       'We steadily delivers promise of good quality and service to its stakeholders at large, sensational product presentations with inventive packaging and exceptional service standards.',
//   },
// ]

export default function BlogComp(): JSX.Element {
  return (
