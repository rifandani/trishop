...
const Contact = () => {
  ...
  return (
    <>
      ...
      {/* contact */}
      <article className="relative flex items-center justify-center min-h-screen mt-5 min-w-screen bg-gradient-to-r from-yellow-800 via-yellow-500 to-yellow-200">
        <div className="container h-full max-w-5xl mx-auto overflow-hidden rounded-lg shadow">
          <div className="h-full sm:flex">
            {/* contact links */}
            <aside className="w-full p-10 bg-yellow-100 rounded-none md:w-1/3 sm:rounded">
              <h2 className="text-2xl font-extrabold leading-8 tracking-tight text-yellow-800 sm:text-2xl sm:leading-9">
                Contact Us
              </h2>
              ...
              <div className="flex items-start py-3 pt-5">
                <div className="flex-shrink">
                  <svg
                    className="w-8 h-8 mt-1 text-yellow-800"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
              ...
              <div className="flex items-start py-3 pb-5">
                ...
                <div className="flex-grow ml-10 md:ml-5">
                  ...
                  <div className="flex text-white text-md sm:text-gray-500">
                    ...
                    <a href="/" className="ml-3 text-gray-400 hover:text-black">
            ...
            <section className="flex items-center justify-center w-full p-10 bg-white md:w-2/3">
              <form className="w-full" onSubmit={onSubmit}>
                ...
                <div className="pt-3">
                  <button
                    className="flex px-6 py-3 text-white bg-yellow-500 rounded-md hover:bg-yellow-600 hover:text-white focus:outline-none focus:shadow-outline focus:border-indigo-300"
                    type="submit"
                  >
                    <svg
                      className="self-center h-4 fill-current"
                      version="1.1"
                      x="0px"
                      y="0px"
                      viewBox="0 0 24 24"
